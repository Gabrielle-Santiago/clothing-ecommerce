...
public class PurchasePersistenceMapperImpl implements PurchasePersistenceMapper {
    ...
    public Purchase toDomain(PurchaseEntity entity) {
        ...
        Purchase purchase = new Purchase( id, clientId, paymentMethod );

        if ( purchase.getItems() != null ) {
            List<PurchaseItem> list = purchaseItemEntityListToPurchaseItemList( entity.getItems() );
            if ( list != null ) {
