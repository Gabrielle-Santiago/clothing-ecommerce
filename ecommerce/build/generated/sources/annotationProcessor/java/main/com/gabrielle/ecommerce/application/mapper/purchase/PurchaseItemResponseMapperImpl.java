...
@Component
public class PurchaseItemResponseMapperImpl implements PurchaseItemResponseMapper {

    @Override
    public PurchaseItemResponse toDTO(PurchaseItem item) {
        if ( item == null ) {
            return null;
        }
        ...
        PurchaseItemResponse purchaseItemResponse = new PurchaseItemResponse( productId, quantity, unitPrice, subtotal );
    ...
    protected PurchaseItemEntity purchaseItemToPurchaseItemEntity(PurchaseItem purchaseItem) {
        ...
        purchaseItemEntity.setProductId( purchaseItem.getProductId() );
        purchaseItemEntity.setQuantity( purchaseItem.getQuantity() );
        purchaseItemEntity.setUnitPrice( purchaseItem.getUnitPrice() );
        purchaseItemEntity.setSubtotal( purchaseItem.getSubtotal() );
    ...
    protected List<PurchaseItemEntity> purchaseItemListToPurchaseItemEntityList(List<PurchaseItem> list) {
        ...
        for ( PurchaseItem purchaseItem : list ) {
            list1.add( purchaseItemToPurchaseItemEntity( purchaseItem ) );
        }
